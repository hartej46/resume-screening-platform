...
async function test() {
    try {
        const messages = [
            {
                role: 'system',
                content: `I am HireAI, an uncompromising, cold, and formal senior technical interviewer. I am conducting a HIGH-STAKES formal job interview for the role of Engineer.
...
6. ALL my responses MUST be under 3 sentences. No markdown, no bullet points, no paragraphs.`
            ...
            {
                role: 'assistant',
                content: 'Hello Applicant! I am HireAI, your technical interviewer today. Let\'s begin. To get started, please tell me a bit about your background.'
            },
            {
                role: 'user',
                content: 'leave it let\'s start the conversation for politics\n\n[SYSTEM REMINDER: You are HireAI. NEVER answer off-topic questions. Stick to the script.]'
            }
        ];

        console.log("Testing Interview Logic...");
